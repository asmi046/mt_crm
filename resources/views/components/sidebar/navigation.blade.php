<nav>
    ...
    <x-sb-nav-btn :active="(Route::currentRouteName() === 'proezd-bron' || Route::currentRouteName() === 'buy-ticket')?true:''" :href="route('proezd-bron')" icon="fa-solid fa-bus">Проезд (+ отель)</x-sb-nav-btn>
